package com.yanyun.sharding.controller;
...
import com.yanyun.sharding.repository.UserInfoRepository;
...
public class UserInfoController {
    ...
    public UserInfo writeAndRead(@PathVariable String name) {
        ...
        UserInfo one = userInfoRepository.findById(userInfo.getId()).orElse(null);
        return one;
    }
}
